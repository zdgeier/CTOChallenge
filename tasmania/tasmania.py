...
combined_dummies = pd.get_dummies(data = combined_base, columns = categorical_columns)
...
train, test, train_labels, test_labels =  train_test_split(X, Y, test_size = .32)

# I got the best results with LR
lr = LogisticRegression(solver='liblinear', multi_class='auto', C=8.5)
